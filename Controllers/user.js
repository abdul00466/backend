...
//old keys
// AWS_ACCESS_KEY = AKIA4LK75SMJUKATDRPL
// AWS_SECRET_ACCESS_KEY = wtaQAlI19TlmcOEzJYJ4N/9JwJ8gu0vNOUBbGchM
...
async function sendVerificationEmail  (req, res , next)  {
    ...
    const msg = {
		...
		html: `Congratulations your email address is verified. Our Management team will get in touch with you for ypu avvpunt verification <br> Please wait.`,
    };
    sgMail.send(msg)
    .then(() => {
...
async function sendAccountUpdateEmail  (req, res, next)  {
	console.log(process.env.SENDGRID_API_KEY)
    ...
    const msg = {
		...
		from: 'no-reply@thehandover.com',
		subject: "Account Update....!!!",
		html: `Congratulations your account as  ${req.body.userType} is APPROVED. Login to ${req.body.userType} dashboard and get started with exciting offers.`,
    };
    sgMail.send(msg)
    .then(() => {
        return res.status(200).send({
...
export default {getUsers, getSingleUser, editUser, resetPassword, editPass, forgotPass , addBank, sendVerificationEmail, sendAccountUpdateEmail};