...
biddingRouter.post('/property', isLoggedInUser.isLoggedIn, biddings.getAllBiddingsOnProperty);
...
biddingRouter.post('/toplevelinvestorinfo', isLoggedInUser.isLoggedIn, biddings.topLevelInvestorInfo);
